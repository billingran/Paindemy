    ...
    await User.insertMany([
      {
        classname: "Baguette",
        date: "2023-03-08",
        address: "14 Rue Saint-Denis, 92700 Colombes, Hauts-de-Seine, France",
        description: `Baguette is a type of bread that originated in France in the 18th century. It is a long, thin loaf with a crispy crust and a soft, chewy interior. The word "baguette" comes from the French word for "wand" or "stick," which describes the shape of the bread.
      ...
      {
        classname: "Pain au levain",
        date: "2023-03-08",
        address: "4 Rue Bonaparte, 20000 Ajaccio, Corse-du-Sud, France",
        description: `Pain au levain is a type of bread that originated in France and is now popular in many parts of the world. It is also known as sourdough bread, as it is made using a naturally fermented dough that gives the bread a distinctive sour flavor.
      ...
      },
      {
        classname: "Nordika",
        date: "2023-03-08",
        address: "25 Avenue Pierre Beregovoy, 58000 Nevers, Nièvre, France",
        description: `Nordika is a type of bread that originated in Scandinavia and is now enjoyed in many parts of the world. It is a dense, dark bread made with rye flour and often includes other grains and seeds such as sunflower seeds and flaxseed. Nordika is a hearty bread that is rich in fiber, protein, and other nutrients.
      ...
      {
        classname: "Pain au khorazan",
        date: "2023-03-08",
        address: "14 Rue Saint-Denis, 92700 Colombes, Hauts-de-Seine, France",
        description: `Pain au khorasan is a type of bread made from khorasan wheat, which is also known as Kamut. This ancient grain is believed to have originated in Egypt and is now grown in many parts of the world.
      ...
      },
      {
        classname: "Croissant",
        date: "2023-03-08",
        address: "9 Rue du Pilori, 64100 Bayonne, Pyrénées-Atlantiques, France",
        description:
      ...
      },
      {
        classname: "Brioche",
        date: "2023-03-08",
        address: "14 Rue Paul Louis Lande, 33000 Bordeaux, Gironde, France",
      ...
      {
        classname: "Brioche au sucre",
        date: "2023-03-08",
        address: "9 Rue du Pilori, 64100 Bayonne, Pyrénées-Atlantiques, France",
        description: `Brioche au sucre is a type of sweet bread that is a variation of the classic French brioche pastry. It is made with the same rich, buttery dough as brioche, but is sweetened with sugar and often topped with large sugar crystals for a crunchy texture.
      ...
      },
      {
        ...
        date: "2023-03-08",
        address: "1 Rue Pradier, 75019 Paris, Paris, France",
        description: `Gua Bao, also known as Taiwanese pork belly buns or steamed buns, is a traditional Taiwanese street food that has become popular around the world. Gua Bao consists of a soft, fluffy steamed bun that is folded in half and filled with tender, savory pork belly, pickled vegetables, and a variety of sauces and seasonings.
      ...
      },
      {
        ...
        description: `Naan is a type of flatbread that is a staple in many cuisines of South Asia and Central Asia, including Indian, Pakistani, and Afghan cuisines. It is typically made with a combination of wheat flour, yeast, salt, and water, and may also include ingredients such as yogurt, milk, or ghee.
      ...
      },
      {
        ...
        address:
          "149 Rue Anatole France, 92300 Levallois-Perret, Hauts-de-Seine, France",
        description: `Tortillas are a type of thin, unleavened flatbread made from either corn or wheat flour. They are a staple food in many Latin American countries, including Mexico, where they are an essential component of many traditional dishes such as tacos, quesadillas, and enchiladas.
      ...
      },
      {
        ...
        date: "2023-03-08",
        address: "1 Rue Pradier, 75019 Paris, Paris, France",
        description: `Dumplings are a type of filled dough that are boiled, steamed, or fried, and are a popular food in many cultures around the world. They can be sweet or savory and can be filled with a variety of ingredients, such as meats, vegetables, cheese, or fruits.
